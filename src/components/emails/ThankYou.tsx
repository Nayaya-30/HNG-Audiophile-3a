    ...
    >
      ...
      >
        ...
        <Section style={{ padding: '40px', textAlign: 'center' }}>
          ...
          >
            Hi {order.name.split(' ')[0]}, thanks again for your order{' '}
            <strong>#{order.id.slice(0, 8)}</strong>. We hope you're enjoying
            your new audio equipment!
          </Text>
          ...
          >
            ...
            <Text style={{ margin: '5px 0 20px', color: '#000000' }}>
              Your feedback helps us improve and helps other music lovers make
              informed decisions.
            </Text>
            ...
            <Text style={{ margin: '15px 0 0', color: '#000000' }}>
              Have questions? Contact our support team at{' '}
              <Link
                href="mailto:support@audiophile.com"
                style={{ color: '#D87D4A', textDecoration: 'none' }}
              >
