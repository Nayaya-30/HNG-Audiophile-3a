...
<body>
  <div class="container">
    <div class="header">
      <div class="logo">
        <img src="https://audiophile-ecommerce-website.netlify.app/assets/shared/desktop/logo.svg" alt="Audiophile" width="150">
      </div>
    ...
    <div class="content">
      ...
      <div class="totals">
        <div class="total-row">
          <div>Subtotal:</div>
          <div>$${(order.grandTotal - 50 - (order.vat || 0)).toFixed(2)}</div>
        </div>
        <div class="total-row">
          <div>Shipping:</div>
          <div>$50.00</div>
      ...
      <p style="margin-top: 30px; color: #666; text-align: center;">
        A confirmation of your order has been sent to <span class="highlight">${order.email}</span>.<br>
    ...
    <div class="footer">
      ...
      <p>High quality audio equipment for true music lovers</p>
    </div>
  </div>
</body>
</html>
